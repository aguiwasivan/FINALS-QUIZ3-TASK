...
function App() {
  ...
  const fetchTasks = async () => {
    ...
    const response = await fetch("https://aiivan.pythonanywhere.com/api/tasks/");
  ...
  const addTask = async () => {
    ...
    await fetch("https://aiivan.pythonanywhere.com/api/tasks/", {
      method: "POST",
      headers: {
  ...
  const completeTask = async (task) => {
    ...
    await fetch(`https://aiivan.pythonanywhere.com/api/tasks/${task.id}/`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteTask = async (taskId) => {
    ...
    await fetch(`https://aiivan.pythonanywhere.com/api/tasks/${taskId}/`, {
      method: "DELETE",
    });
